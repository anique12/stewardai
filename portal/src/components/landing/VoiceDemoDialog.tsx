...
/**
 * Renders a "Talk to MeetBase Agent" button that opens a modal hosting the live
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-sm overflow-hidden border-border bg-card sm:rounded-3xl">
        ...
        <DialogTitle className="sr-only">Talk to MeetBase Agent</DialogTitle>
